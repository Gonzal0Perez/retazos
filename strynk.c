...
void * String_constructor (void * _self, va_list * app){struct String * self = _self;const char * text = va_arg(* app, const char *); /* */int cr=0; char rsource[]=" aaa bbb ccc asdf ",list[]=" 2 1 4 3 ",dlist[]=" 1 4 3 2 " ;/* ccr=(sizeof(func_tcble)/sizeof(func_tcble[0]))-1;*/ 				                                       
				                                         /* */  
...
int main( ) {/*int method(); */int i=0;char *mystr[256];
struct String *str = new(String, "*.c");
/*struct String *aux = StringClas.clone(str);printf("%d\n", StringClas.equals(str,aux)); */
printf("count %d ",ring->count);delete(str);return 0;} 
